...
import { Smartphone, TrendingUp, AlertTriangle, MapPin, Activity, Download, Clock, Layers } from 'lucide-react';
...
export default function AnalyticsPage() {
  ...
  return (
    <AdminLayout>
      ...
      <div id="analytics-report-content" className="p-8 h-full overflow-y-auto bg-[#f5f7f9] relative">
        
        {/* EXPORT ACTION BUTTON OVERLAY */}
        <div className="flex justify-end mb-4">
          <button 
            onClick={handleDownloadPDF} 
            className="bg-[#b32d2d] hover:bg-[#8b2323] text-white transition-all text-xs font-bold px-4 py-2 rounded-lg flex items-center gap-2 active:scale-95 shadow-md"
          >
